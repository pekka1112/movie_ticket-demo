...
@WebServlet(name = "TheatersServlet", urlPatterns = {"/theaters-servlet"})
public class TheatersController extends HttpServlet {
    ...
    private static void initData(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("/theaters.jsp");
