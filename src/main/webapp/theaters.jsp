...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="theaters.jsp">Rạp chiếu</a></li>
    ...
    <section class="theaters-section">
        <div class="theaters-title" style="padding : 20px 0px 30px 0px;">Tìm Rạp Chiếu Phim PZO</div>
            <div class="theaters-card">
                <input id="theaters-search" class="form-control" type="text" placeholder="Tìm theo tên rạp" aria-label="search">
                <div id="showtimes-list_theaters">
