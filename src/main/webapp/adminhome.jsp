...
<head>
    ...
    <head>
        ...
        <!-- Favicon icon -->
        <link rel="icon" type="image/png" sizes="16x16" href="./assets/images/x-icon.png">
        <!-- Custom CSS -->
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            <div class="navbar-header" data-logobg="skin5">
                ...
                <div class="navbar-brand">
                    <a class="navbar-brand" href="adminhome.jsp.jsp">
...
<script src="./assets/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
