                        ...
                        <div class="slider-info banner-view"  style="background: url(../Movie_Ticket_Website/assets/movie-image/${newestMovie.linkMovieImage}) no-repeat center; background-size: cover; " >
                            <div class="banner-info">
                                ...
                                <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
                                    <iframe width="832" height="349" src="${newestMovie.f}" title="${newestMovie.movieName} - OFFICIAL TRAILER" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </li>
                            ...
                            <div class="box16 mb-0">
                                <a href="../Movie_Ticket_Website/movies.jsp">
                                    ...
                                    <div class="box-content">
                                        <h4>
                                            <span class="post"><span class="fa fa-clock-o"></span> ${m.duration} </span>
                                            <a class="post fa-regular fa-heart text-right"></a>
                                        </h4>
                                    </div>
...
<%--    <div class="showtimes-title" style="padding : 20px 0px 30px 0px;">  </div>--%>
<%--    <div class="border-div-1">--%>
<%--        <div class="container">--%>
<%--            <div class="row">--%>
<%--                <div class="col-5">--%>
<%--                    &lt;%&ndash; truyen du lieu - ten rap chieu phim can tim den HomeController servlet &ndash;%&gt;--%>
...
<%--                    &lt;%&ndash; hien thi toan bo danh sach cinema, click 1 cinema thuc hien truyen cid toi servlet home &ndash;%&gt;--%>
...
<%--                        &lt;%&ndash; hien thi noi dung cinema lay duoc tu home-servlet &ndash;%&gt;--%>
...
<%--                                &lt;%&ndash; hien thi 7 ngay tinh tu hom nay de dat ve &ndash;%&gt;--%>
<%--                                <div class="showtimes-calenderBox" style="text-align: center">--%>
<%--                                    <c:forEach var="i" begin="1" end="7" >--%>
<%--                                        &lt;%&ndash; hien thi 7 ngay bat dau tu ngay chieu phim dang duoc chon &ndash;%&gt;--%>
...
<%--                                    &lt;%&ndash; hien thi cac phim trong ngay duoc chon &ndash;%&gt;--%>
<%--                                    <div class="card">--%>
<%--                                        <div class="card-body">--%>
...
<%--&lt;%&ndash; Section : Hiển thị bình luận nổi bật &ndash;%&gt;--%>
<%--<section class="comments-section">--%>
<%--    <h3 class="hny-title" style="color: #c94c7a; text-align: center" >BÌNH LUẬN NỔI BẬT</h3>--%>
<%--    <div class="border-div-2">--%>
<%--        <div class="container">--%>
<%--            <div class="row align-items">--%>
<%--                <c:forEach items="${comments}" var="c" >--%>
...
<%--&lt;%&ndash; Section : Hiển thị danh sách các rạp chiếu phim &ndash;%&gt;--%>
...
<%--    <div class="border-div-2">--%>
<%--        <div class="row">--%>
<%--            &lt;%&ndash; hien thi 2 rap chieu phim noi bat nhat &ndash;%&gt;--%>
