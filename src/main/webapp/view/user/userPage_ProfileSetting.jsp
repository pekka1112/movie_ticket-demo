            ...
            <div class="author-card pb-3">
                ...
                <div class="author-card-profile">
                    ...
                    <div class="author-card-details">
                        <h5 class="author-card-name text-lg">${sessionScope.get("userdetail").fullName} #${sessionScope.get("curUser").userID}</h5>
            ...
            <form class="row" action="userpage-servlet" method="get">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="account-fn" name="name" value="<%= userDetail.getFullName() %>" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="order-sort" name="gender" >
                            <%
                                if(userDetail.getGender().equals("Nam")) {
                            %>
                            <option selected >Nam</option>
                            <option>Nữ</option>
                            <%
                            } else if (userDetail.getGender().equals("Nữ")) {
                            %>
                            <option>Nam</option>
                            <option selected>Nữ</option>
                            <%
                            } else if (userDetail.getGender() == null) {
                            %>
                            <option>Nam</option>
                            <option>Nữ</option>
                            <%
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        %>
                        <input class="form-control" type="text" id="account-phone" name="phoneNumber" value="<%= userDetail.getPhoneNumber() %>" >
                        <%
                        } else {
                        %>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        %>
                        <input class="form-control" type="text" id="address" name="address" value="<%= userDetail.getAddress() %>" >
                        <%
                        } else {
                        %>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        %>
                        <input class="form-control" type="date" id="dob" name="dob" value="<%= userDetail.getDob() %>" >
                        <%
                        } else {
                        %>
